...
#             if e.args[0] == '请求被重定向':
#                 ApolloIntlClient.sessionId = fetch_sessionId()
#                 res = func(self, *args, **kw)
#             else:
...
#     url = "http://apollo.jiligagatech.com/signin"
...
#
#
# class ApolloIntlClient:
#     host = 'http://apollo.jiligagatech.com'
